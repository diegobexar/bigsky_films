<?php
/**
 * bigsky-theme functions and definitions
 *
...
function big_sky_pictures_setup() {
	/*
		...
		* If you're building a theme based on bigsky-theme, use a find and replace
		* to change 'big-sky-pictures' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'big-sky-pictures', get_template_directory() . '/languages' );
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'big_sky_pictures_custom_background_args',
			array(
